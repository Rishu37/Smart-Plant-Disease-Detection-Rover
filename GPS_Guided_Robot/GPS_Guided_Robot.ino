...
#include <QMC5883LCompass.h>                                             // Library for the compass - Download from Github @ https://github.com/jarzebski/Arduino-HMC5883L
...
unsigned long c = 0;                                                  // HMC5883L compass(HMC5883L)
...
{  
  ...
  myservo.attach(9);    
   c = millis();                                           // attaches the servo to pin 9 (Servo 0 on the Adafruit Motor Control Board)
  ...
  compass.init();                                                 // initialize the compass (HMC5883L)
  // compass.setMode();                          // Set measurement range  
